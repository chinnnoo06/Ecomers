...
<body>
    ...
    <section class="Prenda">
        <div class="detalles-prenda">
            ...
            <div class="DatosPrenda">
                ...
                <div class="btn">
                    <form action="AgregarPrendaCarritoUsuario.php" method="POST" class="formulario">
                    ...
                    <form action="PagarAhora.php" method="POST" id="pagarAhoraForm">
                        <button type="submit" class="boton-Pagar animable">Pagar Ahora</button>
                        <input type="hidden" name="Codigo" value="<?= $prenda['Codigo'] ?>">
                        <input type="hidden" name="Talla" id="TallaPagar" required>
                        <input type="hidden" name="Cantidad" id="CantidadPagar" required>
    ...
    <section class="Calificacion" id="Calificacion">
        <div class="contenido-Calificacion">
            ...
            <form action="AgregarCalificacionUsuario.php" method="POST">
            ...
            <ul>
                <?php foreach ($opiniones as $opinion): ?>
                    <li class="opinion-item">
                        ...
                        <?php if ($opinion['Usuario'] == $usuarioId): ?>
                            <form action="EliminarCalificacionUsuario.php" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta calificación?');">
