    ...
    <!-- Sección de inicio -->
        ...
        <section id="blog" class="blog">
            <div class="contenido-blog">
                ...
                <div class="btn-blogs">
                    <a href="BlogDetalleVisitante.php"><button class="animable">Ver Blogs</button></a>
                </div>
                <div class="blog-grid">
                    <?php if (mysqli_num_rows($resultadoBlog) > 0): ?>
                        <?php while ($entrada = mysqli_fetch_assoc($resultadoBlog)): ?>
                            <article class="entrada-blog">
                                ...
                                <a href="BlogDetalleVisitante.php?Id=<?= $entrada['Id'] ?>"><button class="animable">Leer más</button></a>
                            </article>
                        <?php endwhile; ?>
                    <?php else: ?>
